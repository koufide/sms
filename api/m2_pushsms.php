...
$file_lock_push_sms = $param->files->file_lock_mpush_sms2; #  2ieme diffusion
...
if ($dossier = opendir($push_rep)) {
    while (false !== ($fichier = readdir($dossier))) {
        if ($fichier != '.' && $fichier != '..' && $fichier != 'index.php' && $fichier != 'archive') {
            ...
            if (preg_match("/^M2PUSH/i", $filename)) {
                // if (preg_match("/^M2PUSH/i", $filename)) {  # 2ieme diffusion manuelle
                                    ...
                                    if ($line != "." && $line != "..") {
                                        ...
                                        if (!empty($tab_line)) {
                                            ...
                                            if ($res_flooding == 0) {
                                                ...
                                                if (array_key_exists('requestError', $tab_message )){
